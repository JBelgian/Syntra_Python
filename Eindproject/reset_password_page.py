...
# TITLE PAGE
L_Title = Label(reset_pwd_page, text="FC Syntra - Herstel paswoord", fg='White', bg='DodgerBlue3',
                font=('Helvetica', 50))
L_Title.pack(pady=40)

# INFO LABEL ONDER TITEL PAGINA
L_info = Label(reset_pwd_page,
               text="Voeg Uw Emailadres In Druk Op ""Herstel Paswoord"". Na Een Paar Minuten Ontvangt U Een Email Met "
                    "Login Gegevens.",
               fg='White', bg='DodgerBlue3', font=('Helvetica', 14))
L_info.pack(pady=30)

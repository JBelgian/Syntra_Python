...
# If the user doesn't have an account, from the main login page there#
...
def check_password():
    ...
    if mat:
        ...
        messagebox.showinfo("", "Paswoord is niet geldig! Het voldoet niet aan de voorwaarden: \n"
                                ...
                                "Er moet minstens 1 speciaal teken hebben.\nHet moet tussen de 6 en 20 karakters lang "
                                "zijn")
...
def validate_data():
    ...
    if teller < 12:
        ...
        sql = "INSERT INTO leden (voornaam, achternaam, email, land, postcode, gemeente, straat, telefoon,gsm," \
              "aanspreking,taal, paswoord) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) "
...
# TITLE PAGE
L_Title = Label(create_acc_page, text="FC Syntra - Aanmaak Account", fg='White', bg='DodgerBlue3',
                font=('Helvetica', 40))
...
mandatory_f_label = Label(text="( Alle velden zijn verplicht, tenzij anders vermeld )", bg="DodgerBlue3", fg="White",
                          font=('Helvetica', 10))
...
voorwaarden_label = Label(text="Ik aanvaard de algemene voorwaarden", bg="DodgerBlue2", fg="White",
                          font=('Helvetica', 12))
...
# LASTNAME
lastname_entry = Entry(create_acc_page, width=50, highlightthickness=2)
...
country_cb['values'] = (
    ...
    'Liberia', 'Libya', 'Liechtenstein', 'Lithuania', 'Luxembourg', 'Macao', 'Macedonia, Republic of', 'Madagascar',
...
info_check_box = Checkbutton(create_acc_page, variable=info_check, onvalue=1, offvalue=0, bg="DodgerBlue2",
                             highlightthickness=2)
info_check_box.place(x=370, y=820)

# CHECK BOX VOORWAARDEN
conditions_checkb = Checkbutton(create_acc_page, variable=conditions_check, onvalue=1, offvalue=0, bg="DodgerBlue2",
                                highlightthickness=2)

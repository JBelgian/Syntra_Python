        ...
        while (not naam == "einde"):
            if not naam in lijst:
                ...
                if (bevestig == "j"):
                    lijst.append(naam)
                    Log = open("Logboek.txt", "a")
                    Log.writelines(datetime.datetime + naam + " is toegevoegd" + "\n")
                    Log.close()
            else:
...
def verwijder_naam(lijst):
    ...
    if naam in lijst:
        ...
        if (bevestig == "j"):
            lijst.remove(naam)
            Log = open("Logboek.txt", "a")
            Log.writelines(datetime.datetime + naam + " is verwijderd" + "\n")
            Log.close()
...
def sorteer_lijst(lijst):
    lijst.sort()
    Log = open("Logboek.txt", "a")
    Log.writelines(datetime.datetime + "Lijst is gesorteerd" + "\n")
    Log.close()
